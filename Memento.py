...
class Memento(object):
	...
	def loadMemento(self, dataArray):
		...
		Data.Data.createOrLoad = dataArray[3]
		Data.Data.stokesOrNS = dataArray[4]
		Data.Data.reynolds = dataArray[5]
		Data.Data.transientOrSS = dataArray[6]
		Data.Data.xdim = dataArray[7]
		Data.Data.ydim = dataArray[8]
		Data.Data.xelem = dataArray[9]
		Data.Data.yelem = dataArray[10]
		Data.Data.polyOrder = dataArray[11]
		Data.Data.inflowCond = dataArray[12]
		Data.Data.inflowRegion = dataArray[13]
		Data.Data.inflowXVelocity = dataArray[14]
		Data.Data.inflowYVelocity = dataArray[15]
		Data.Data.outflowCond = dataArray[16]
		Data.Data.outflowRegion = dataArray[17]
		Data.Data.outflowXVelocity = dataArray[18]
		Data.Data.outflowYVelocity = dataArray[19]
		Data.Data.wallCond = dataArray[20]
		Data.Data.wallRegion = dataArray[21]
		Data.Data.horp = dataArray[22]
		Data.Data.aorm = dataArray[23]
		Data.Data.manualElems = dataArray[24]
		Data.Data.inflowsAskedFor = dataArray[25]
		Data.Data.outflowsAskedFor = dataArray[26]
		Data.Data.wallsAskedFor = dataArray[27]
